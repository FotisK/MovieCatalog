...
να μην ξεχάσω (python buggy without locale:
...
def CountryNameByCode(name):
	...
	countries = {"AF": "Afghanistan", "AL": "Albania", "DZ": "Algeria", "AS": "American Samoa", "AD": "Andorra", "AO": "Angola", "AI": "Anguilla", "AQ": "Antarctica", "AG": "Antigua and Barbuda", "AR": "Argentina", "AM": "Armenia", "AW": "Aruba", "AU": "Australia", "AT": "Austria", "AZ": "Azerbaijan", "BS": "Bahamas", "BH": "Bahrain", "BD": "Bangladesh", "BB": "Barbados", "BY": "Belarus", "BE": "Belgium", "BZ": "Belize", "BJ": "Benin", "BM": "Bermuda", "BT": "Bhutan", "BO": "Bolivia, Plurinational State of", "BQ": "Bonaire, Sint Eustatius and Saba", "BA": "Bosnia and Herzegovina", "BW": "Botswana", "BV": "Bouvet Island", "BR": "Brazil", "IO": "British Indian Ocean Territory", "BN": "Brunei Darussalam", "BG": "Bulgaria", "BF": "Burkina Faso", "BI": "Burundi", "KH": "Cambodia", "CM": "Cameroon", "CA": "Canada", "CV": "Cape Verde", "KY": "Cayman Islands", "CF": "Central African Republic", "TD": "Chad", "CL": "Chile", "CN": "China", "CX": "Christmas Island", "CC": "Cocos (Keeling) Islands", "CO": "Colombia", "KM": "Comoros", "CG": "Congo", "CD": "Congo, the Democratic Republic of the", "CK": "Cook Islands", "CR": "Costa Rica", "Code": "Country name", "HR": "Croatia", "CU": "Cuba", "CW": "Curaçao", "CY": "Cyprus", "CZ": "Czech Republic", "Côte d'Ivoire": 'CI', "DK": "Denmark", "DJ": "Djibouti", "DM": "Dominica", "DO": "Dominican Republic", "EC": "Ecuador", "EN": "England", "EL": "Greece", "EG": "Egypt", "SV": "El Salvador", "GQ": "Equatorial Guinea", "ER": "Eritrea", "EE": "Estonia", "ET": "Ethiopia", "FK": "Falkland Islands (Malvinas)", "FO": "Faroe Islands", "FJ": "Fiji", "FI": "Finland", "FR": "France", "GF": "French Guiana", "PF": "French Polynesia", "TF": "French Southern Territories", "GA": "Gabon", "GM": "Gambia", "GE": "Georgia", "DE": "Germany", "GH": "Ghana", "GI": "Gibraltar", "GR": "Greece", "GL": "Greenland", "GD": "Grenada", "GP": "Guadeloupe", "GU": "Guam", "GT": "Guatemala", "GG": "Guernsey", "GN": "Guinea", "GW": "Guinea-Bissau", "GY": "Guyana", "HT": "Haiti", "HM": "Heard Island and McDonald Islands", "VA": "Holy See (Vatican City State)", "HN": "Honduras", "HK": "Hong Kong", "HU": "Hungary", "uk": "United Kingdom", "IS": "Iceland", "IN": "India", "ID": "Indonesia", "IR": "Iran, Islamic Republic of", "IQ": "Iraq", "IE": "Ireland", "IM": "Isle of Man", "IL": "Israel", "IT": "Italy", "JM": "Jamaica", "JP": "Japan", "JE": "Jersey", "JO": "Jordan", "KZ": "Kazakhstan", "KE": "Kenya", "KI": "Kiribati", "Korea, Democratic People's Republic of": 'KP', "KR": "Korea, Republic of", "KW": "Kuwait", "KG": "Kyrgyzstan", "Lao People's Democratic Republic": 'LA', "LV": "Latvia", "LB": "Lebanon", "LS": "Lesotho", "LR": "Liberia", "LY": "Libya", "LI": "Liechtenstein", "LT": "Lithuania", "LU": "Luxembourg", "MO": "Macao", "MK": "Macedonia, the former Yugoslav Republic of", "MG": "Madagascar", "MW": "Malawi", "MY": "Malaysia", "MV": "Maldives", "ML": "Mali", "MT": "Malta", "MH": "Marshall Islands", "MQ": "Martinique", "MR": "Mauritania", "MU": "Mauritius", "YT": "Mayotte", "MX": "Mexico", "FM": "Micronesia, Federated States of", "MD": "Moldova, Republic of", "MC": "Monaco", "MN": "Mongolia", "ME": "Montenegro", "MS": "Montserrat", "MA": "Morocco", "MZ": "Mozambique", "MM": "Myanmar", "NA": "Namibia", "NR": "Nauru", "NP": "Nepal", "NL": "Netherlands", "NC": "New Caledonia", "NZ": "New Zealand", "NI": "Nicaragua", "NE": "Niger", "NG": "Nigeria", "NU": "Niue", "NF": "Norfolk Island", "MP": "Northern Mariana Islands", "NO": "Norway", "OM": "Oman", "PK": "Pakistan", "PW": "Palau", "PS": "Palestine, State of", "PA": "Panama", "PG": "Papua New Guinea", "PY": "Paraguay", "PE": "Peru", "PH": "Philippines", "PN": "Pitcairn", "PL": "Poland", "PT": "Portugal", "PR": "Puerto Rico", "QA": "Qatar", "RO": "Romania", "RU": "Russian Federation", "RW": "Rwanda", "RE": "Réunion", "BL": "Saint Barthélemy", "SH": "Saint Helena, Ascension and Tristan da Cunha", "KN": "Saint Kitts and Nevis", "LC": "Saint Lucia", "MF": "Saint Martin (French part)", "PM": "Saint Pierre and Miquelon", "VC": "Saint Vincent and the Grenadines", "WS": "Samoa", "SM": "San Marino", "ST": "Sao Tome and Principe", "SA": "Saudi Arabia", "SN": "Senegal", "RS": "Serbia", "SC": "Seychelles", "SL": "Sierra Leone", "SG": "Singapore", "SX": "Sint Maarten (Dutch part)", "SK": "Slovakia", "SI": "Slovenia", "SB": "Solomon Islands", "SO": "Somalia", "ZA": "South Africa", "GS": "South Georgia and the South Sandwich Islands", "SS": "South Sudan", "ES": "Spain", "LK": "Sri Lanka", "SD": "Sudan", "SR": "Suriname", "SJ": "Svalbard and Jan Mayen", "SZ": "Swaziland", "SE": "Sweden", "CH": "Switzerland", "SY": "Syrian Arab Republic", "TW": "Taiwan, Province of China", "TJ": "Tajikistan", "TZ": "Tanzania, United Republic of", "TH": "Thailand", "TL": "Timor-Leste", "TG": "Togo", "TK": "Tokelau", "TO": "Tonga", "TT": "Trinidad and Tobago", "TN": "Tunisia", "TR": "Turkey", "TM": "Turkmenistan", "TC": "Turks and Caicos Islands", "TV": "Tuvalu", "UG": "Uganda", "UA": "Ukraine", "AE": "United Arab Emirates", "GB": "Great Britain", "US": "United States", "UM": "United States Minor Outlying Islands", "UY": "Uruguay", "UZ": "Uzbekistan", "VU": "Vanuatu", "VE": "Venezuela, Bolivarian Republic of", "VN": "Viet Nam", "VG": "Virgin Islands, British", "VI": "Virgin Islands, U.S.", "WF": "Wallis and Futuna", "EH": "Western Sahara", "YE": "Yemen", "ZM": "Zambia", "ZW": "Zimbabwe", 'Åland Islands': 'AX'}
	...
	for ak, av in a.items():
		if ak in b:
			...
			if type(av) is list:
				...
				if ak in ['CreatedBy','Directors','Writers','Producers','Cinematographers','ArtDirectors','Cast']:
						...
						if b_index >= 0: #found inside b!
							...
							if av[a_index].get('PortraitURL'):
								if av[a_index]['PortraitURL'] is not None:
									tmpItem['PortraitURL'] = av[a_index].get('PortraitURL')
								else:
									print("Bug, Shouldn't be none, should had already been filtered out")
...
def doesFileExist(BaseDir,MovieName,FileName):
	if MovieName != "" and BaseDir != "" and FileName != "":
		...
		print("Bug, testing for existence of file, without setting file, folder or moviename - why?")
		return False
...
def isValidMovieFile(BaseDir,MovieNameWithExtension):
	...
	if os.path.isdir(FileURI):
		if includeFoldersInValidFileTypes and not MovieNameWithExtension.endswith(".ffiles"):
			return True #is folder, and not a cache folder. Assume it's a movie!
		else:
			return False #is cache folder or we don't care about folders (in case where you have same cache and source folders)
	else:
...
def ParseDuckDuckGoSearchResults(PageText):
	...
	try:
		...
		print("bug, DuckDuckGo did not return results for query," 
...
def isFolderOrphan(SourceFilesList,CacheDir,StrippedMovieName):
	if StrippedMovieName != "" and len(SourceFilesList)>0:
		...
		if includeFoldersInValidFileTypes:
			GeneratedNameVariants.add(StrippedMovieName+os.sep) #FUTURE192938: for folder testing, also create a variant with trailing /
...
def BuildIndex(MoviesCatalog):
	...
	output = template.render(genres=GenresList, foundmovies=True, movies=MoviesCatalog, CachePath=CacheRelativePath, HowManyActorsShouldDisplay=constHowManyActorsShouldDisplay)
...
def GenerateGalleryThumbnail(BaseDir,MovieName,input_file="poster.jpg",output_file="poster_thumbnail.jpg",basewidth=256):
...
def GetHeadshotURL(personID,Condition=True,Provider="tmdb"):
	if Condition == False: #should I fetch data? condition eg. if counter < 7, do! else --> stop fetching
	...
	if 'full-size headshot' in tmpPerson.keys():
		...
		if tmpImageURL:
			if re.match(r'^https?://.*\.jpg$', tmpImageURL):
				...
				print("Error - found headshot for "+tmpPerson['name']+" but format is not URL but ["+tmpPerson['full-size headshot']+"]")
	return None
...
def WrapTMDBDataInIMDB(IMDBMovieID):
	...
	requestURL = 'https://api.themoviedb.org/3/'+kind+'/' \
		+ str(movieID) \
		+ '?api_key=' + myTMDB_APIkey \
		+ '&language=en-US&append_to_response' \
	...
	if 'original_title' in tmpJSON:
		...
		MovieInformation['OtherTitles'].append(tmpJSON.get('original_title')+" (original)")
	if 'original_name' in tmpJSON:
		MovieInformation['OriginalTitle']=tmpJSON.get('original_name')
		MovieInformation['OtherTitles'].append(tmpJSON.get('original_name')+" (original)")
	...
	if 'credits' in tmpJSON:
		if 'crew' in tmpJSON['credits']:
			...
			for tmpD in tmpJSON['credits'].get('crew'):
				...
				if tmpD.get('job') == 'Screenplay' or tmpD.get('job') == 'Writer' or tmpD.get('job') == 'Author':
					tmp = {
							'Name': tmpD.get('name'),
							'TMDBID': tmpD.get('id'),
						}
				...
				if tmpD.get('job') == 'Cinematography' or tmpD.get('job') == 'Director of Photography':
					tmp = {
							'Name': tmpD.get('name'),
							'TMDBID': tmpD.get('id'),
						}
	...
	if 'videos' in tmpJSON and 'results' in tmpJSON['videos']:
		for tmpD in tmpJSON['videos'].get('results'):
			if tmpD['iso_639_1'] == "en" or not MovieInformation['TrailerID']:
				if tmpD['site'] == "YouTube" and \
					tmpD['type'] == "Trailer" and \
					len(tmpD['key']) > 8: #should be 11, but arbirarily I asked 8 minimun :-p
...
def FetchMovieDataIMDBLite(MovieID,getPeople=False):
	...
	try:
		...
		ia.update(movieData, info=['keywords','vote details','taglines','critic reviews'])	
	...
	if 'runtimes' in movieData:
		tmpMovieDictionary['Duration'] = int(movieData.get('runtimes')[0])#is it list?
	...
	if 'number of votes' in movieData:
		tmpMovieDictionary['ImdbVoteDistribution'] = copy.copy(movieData.get('number of votes'))
	if 'demographics' in movieData:
		tmpMovieDictionary['ImdbVoteDemographics'] = copy.deepcopy(movieData.get('demographics'))
...
def ConstructIMDBIDfromNumber(movieID,idtype="movie"):
	...
	if type(movieID) == int:
		...
		if idtype=="movie":
			...
			#print("is!")
			return 'nm'+movieID
	print("Bug - ConstructIMDBIDfromNumber shouldn't ever reach here. Movie/Person ID is:")
	print(movieID)
	print(type(movieID))
	return None
...
def ConstructTMDBImageURL(ImageName,ImageWidth="w780"):
	...
	if ImageName and ImageWidth:
		tmpURL = 'https://image.tmdb.org/t/p/' \
	...
	if response.status_code == requests.codes.ok:
		...
		if tmpJSON['results']:
			...
			for tmpVideoFileResult in tmpJSON['results']:
				...
				if tmpVideoFileResult['site'] == "YouTube" and \
					tmpVideoFileResult['type'] == "Trailer" and \
					 len(tmpVideoFileResult['key']) == 11:
					#print("5")
...
def getTMDBDetailsfromIMDBID(movieID,idtype="movie"):
	#https://api.themoviedb.org/3/find/tt0816692?api_key=096187be7a5391bfa9843173e059137d&language=en-US&external_source=imdb_id
	requestURL = 'https://api.themoviedb.org/3/find/' \
	...
	if idtype == "movie" or idtype == "tv":
		if tmpJSON[idtype + '_results']:
			...
			tmpJSON[idtype + '_results'][0]['TMDBRating'] = tmpJSON[idtype + '_results'][0]['vote_average']
			#if tmpJSON[0][idtype + '_results']['vote_count']:
			tmpJSON[idtype + '_results'][0]['TMDBVotes'] = tmpJSON[idtype + '_results'][0]['vote_count']
			#if tmpJSON[0][idtype + '_results']['vote_average']:
			tmpJSON[idtype + '_results'][0]['TMDBAdult'] = tmpJSON[idtype + '_results'][0]['adult']
			tmpJSON[idtype + '_results'][0]['TMDBPopularity'] = tmpJSON[idtype + '_results'][0]['popularity']
...
def WriteDataToFile(Data,FileURI,Overwrite = False):
	if FileURI:
		if os.path.exists(FileURI) and Overwrite == False:
			raise FileExistsError('Bug, file writen to already exists and overwrite is set to False')
...
def BuildLaunchOptions(argv):
	LaunchOptions={
		"ListItems":False,
		"DisplayedItemsStatus":["Ambiguous","Verified","Unverified","Unimported","Incomplete"],
		"Filename":None,
		"ImdbID":None,
		"UpdateFile":False,
	...
	try:
		opts, args = getopt.getopt(argv,"?hl:sd:f:i:ct:",["help","list=","set","display=","file=","imdb=","--change","--status="])
	...
	for opt, arg in opts:
		if opt.lower() in ('-h',"-?","--help"):
			...
			print('-l [all,ambiguous,unimported,verified,incomplete], --list [all,ambiguous,unimported,verified,incomplete]: list all,ambiguous or unimported movies with their IMDB ID')
			print('-c -f <filename> -i <new imdbID> -t [Unimported/Unverified/Verified/Ambiguous/Incomplete], --change --file <filename> --imdb <new imdbID> --status [Unimported/Unverified/Verified/Ambiguous/Incomplete]: match imdbID and/or manually set status for movie with given filename')
			...
			print('-i <imdbID>, --imdb <imdbID>: displays details for movie with imdb ID')
			...
			if arg.lower() in ("", "all"):
				...
				print ("invalid list argument --list should be all/ambiguous/unimported/verified/incomplete")
				sys.exit()
			...
			if arg.lower() in ("ambiguous","unimported","unverified","verified","incomplete"):
				LaunchOptions["NewStatus"] = arg.lower().capitalize()
			else:
				print ("Invalid Status: should be Unimported, Unverified, Verified, Ambiguous or Incomplete")
				sys.exit()
	...
	if LaunchOptions["UpdateFile"]:
		if not LaunchOptions["Filename"]:
			...
			print("invalid syntax for -c,--change: Missing new imdbid or/and new Status ")
...
constHowManyActorsShouldDisplay = 6 #pass this const/var to javascript - how many actors should I display for each movie?
...
def main(argv):
	...
	if os.path.isdir(SourcePath) and os.path.isdir(CachePath):
		if LaunchOptions["ListItems"]:
					print("\n")
					print("   \t{:^30.30}\t{:<4.4}\t{:<7.7}\t{:<13.13}\t{:<60.60}".format("Movie Name","Year","IMDB ID","Import Status","Filename"))
					print("{:_<132}".format(""))
		myreps=0
		...
		CacheFilesList={}
		if includeFoldersInValidFileTypes:
			SourceFilesList={f+os.sep for f in os.listdir(SourcePath) if os.path.isdir(os.path.join(SourcePath, f))}
		SourceFilesList = SourceFilesList.union({f for f in os.listdir(SourcePath) if os.path.isfile(os.path.join(SourcePath, f))})
		#CacheFilesList=os.listdir(CachePath)
		if includeFoldersInValidFileTypes:
			CacheFilesList={f+os.sep for f in os.listdir(CachePath) if os.path.isdir(os.path.join(CachePath, f,os.sep))}
		CacheFilesList = CacheFilesList.union({f for f in os.listdir(CachePath) if os.path.isfile(os.path.join(CachePath, f))})
		for File in CacheFilesList:
			...
			if File.endswith(".ffiles/"):
				...
				if LaunchOptions["ScanFolder"] and isFolderOrphan(SourceFilesList,CachePath,StrippedMovieName):
					print("deleting: " + File)
		...
		for File in SourceFilesList:
			...
			if isValidMovieFile(SourcePath,File):
				...
				if LaunchOptions["UpdateFile"] and LaunchOptions["Filename"]==File and LaunchOptions["Filename"]:
					ShouldUpdateFile=True #apparently, this is one file that needs updating! Bypassing main loop
					print(".")
				if (ShouldUpdateFile and LaunchOptions["ImdbID"]) or (LaunchOptions["ScanFolder"] and isMissingDataFile(CachePath,StrippedMovieName)):
					myreps+=1
					if myreps % 25 == 0:
						print("sleeping:")
					...
					MovieID2 = None
					MovieID = None
					if LaunchOptions["UpdateFile"] and LaunchOptions["ImdbID"] and ShouldUpdateFile:
						MovieID1 =LaunchOptions["ImdbID"]
						print("fetching data for movie with ID "+ str(MovieID1))
						MovieID2 = MovieID1
						MovieName = "New"
					else:
						MovieID1 = GetMovieIDfromWeb(MovieName,info['year'],Provider = "google")
						if shouldCrossReferenceOnDuckDuckGo:
							#check on duckduckgo too!
							MovieID2 = GetMovieIDfromWeb(MovieName,info['year'],Provider = "duckduckgo")
						else:
					...
					if MovieID1 == MovieID2 and MovieID1 == -1:
						...
						if MovieID1 == -1:
							MovieID = MovieID2 #if duckduckgo had an answer and google didn't, pick duckduckgo (though it's 99% wrong)
						else:
							MovieID = MovieID1 #google does better, anyways, so pick google.
						if MovieID1 != MovieID2:
							print("Ambiguity: %s is %d on google and %d on duckduckgo" %(MovieName,MovieID1,MovieID2))
							tmpMovieData['Status'] = "Ambiguous"
						else:
							print("%s ID is %d" %(MovieName,MovieID))
							if LaunchOptions["UpdateFile"] and ShouldUpdateFile:
								tmpMovieData['Status'] = "Verified" #hey, it's set by the user!
							else:
								tmpMovieData['Status'] = "Unverified" #automatic match, might be wrong
						if MovieID > 0:
							#for x in range(40):
							...
							if tmpData:
								...
								print("Error, couldn't find movie with ImdbID %d on TMDB" %(MovieID))
								tmpMovieData['Status'] = "Incomplete" #assumed TMDB found nothing, deem data incomplete
						else:	
							print("Bug, couldn't find movie because I chose movieID %d whereas it should never reach here" %(MovieID))
						...
						if 'TMDBPoster' in tmpMovieData:
							PosterURL = ConstructTMDBImageURL(tmpMovieData['TMDBPoster'],ImageWidth="original")
							if PosterURL:
								if isMissingPosterFile(CachePath,StrippedMovieName) or ShouldUpdateFile:
									PosterData = getImageDataFromURL(PosterURL)
									PosterFileName = os.path.join(CachePath,StrippedMovieName+".ffiles","poster.jpg")
									WriteDataToFile(PosterData,PosterFileName,ShouldUpdateFile)
								else:
									print("Bug, poster file already exists in folder - why? should had already purged")
						if 'TMDBBackdrop' in tmpMovieData:
							BackdropURL = ConstructTMDBImageURL(tmpMovieData['TMDBBackdrop'],ImageWidth="original")
							if BackdropURL:
								if isMissingBackdropFile(CachePath,StrippedMovieName) or ShouldUpdateFile:
									BackdropData = getImageDataFromURL(BackdropURL)
									BackdropFileName = os.path.join(CachePath,StrippedMovieName+".ffiles","backdrop.jpg")
									WriteDataToFile(BackdropData,BackdropFileName,ShouldUpdateFile)
								else:
									print("Bug, backdrop file already exists in folder - why? should had already purged")

						#DATA POST FIXES -- for everytime you import something:
						#1. remove authorname from plot
						tmpMovieData['Plot'] = RemoveAuthorFromPlot(tmpMovieData['Plot'])
						tmpMovieData['Languages'] = ConvertLanguageCodeToName(tmpMovieData['Languages'])
						tmpMovieData['Countries'] = ConvertCountryCodeToName(tmpMovieData['Countries'])
					tmpMovieData['DateAdded'] = time.strftime('%Y-%m-%d', time.gmtime(os.path.getmtime(FileURI)))
					# ^--- date that the movie file was added
					tmpMovieData['DateImported'] = datetime.date.today().strftime("%Y-%m-%d")
					...
					CreateMovieDataFile(CachePath,StrippedMovieName,tmpMovieData,ShouldUpdateFile)
					if doesFileExist(CachePath, tmpMovieData['Filename'], 'poster.jpg') and (ShouldUpdateFile or not doesFileExist(CachePath, tmpMovieData['Filename'], 'poster_thumbnail.jpg')):
						GenerateGalleryThumbnail(CachePath, tmpMovieData['Filename'], "poster.jpg", "poster_thumbnail.jpg",DefaultThumbnailWidth)
				...
				ignore_not_found = (not LaunchOptions["ScanFolder"]) #ignore not found files and suppress warnings, if you were not asked to scan (and update files)
				
				MovieData2 = RestoreMovieDataFile(CachePath,StrippedMovieName,ignore_not_found)
				...
				if MovieData2:
					if LaunchOptions["ListItems"] and MovieData2["Status"] in LaunchOptions["DisplayedItemsStatus"]:
						if MovieData2["Status"] == "Verified":
							print("[+]\t{:<30.30}\t{:4d}\t{:7d}\t{:>13.13}\t{:<10.60}".format(MovieData2.get("Title"),MovieData2.get("ReleaseYear"),MovieData2.get("ImdbID"),MovieData2.get("Status"),MovieData2.get("Filename")))
						if MovieData2["Status"] == "Unimported":
							print("[-]\t{:^30.30}\t{:^4.4}\t{:^7.4}\t{:>13.13}\t{:<10.60}".format("-","-","-",MovieData2.get("Status"),MovieData2.get("Filename")))
				...
				if ShouldUpdateFile and MovieData2:
					if LaunchOptions["UpdateFile"] and LaunchOptions["NewStatus"] and ShouldUpdateFile:
						MovieData2['Status'] = LaunchOptions["NewStatus"]
						UpdateMovieDataFile(CachePath,MovieData2['Filename'],MovieData2)
						print("updating...")
				elif ShouldUpdateFile:
					print("File not imported yet, please import first (with -s,--scan option)")
					#F12BUGGGGGGG
		...
		for Movie in MyMoviesCatalog:
			...
			if Movie.get('DataInternalVersion') < CurrentMovieDataFileVersion:
				print("Old file version. Setting update dirty bit for "+Movie['Filename'])
			...
			if doesFileExist(CachePath, Movie['Filename'], 'poster.jpg') and not doesFileExist(CachePath, Movie['Filename'], 'poster_thumbnail.jpg'):
				GenerateGalleryThumbnail(CachePath, Movie['Filename'], "poster.jpg", "poster_thumbnail.jpg",DefaultThumbnailWidth)
